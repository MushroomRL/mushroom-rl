...
def test_prioritized_dqn():
    ...
    w = approximator.get_weights()
    w_test = torch.tensor([-0.2030196, 0.23955551, -0.02270006, 0.32279772, -0.3566313,
                           -0.01044417, -0.0703411, 0.43429062, 0.16391997])
...
def test_rainbow():
    ...
    w = approximator.get_weights()
    w_test = torch.tensor([0.42544973, -0.25150308, -0.19818449, 0.27129546, 0.4086587, 0.4083576,
                           0.2966448, 0.29879287, -0.5987553, 0.3571231, 0.41761974, 0.2900467,
                           -0.0988204, 0.40659037, 0.0516505, -0.1334352, 0.39855167, 0.39783466,
                           0.3072401, 0.30946139, 0.23023176, 0.00077488, 0.3852492, 0.32121828,
                           0.297641, -0.23468482, -0.09094006, -0.1045344, 0.38619098, 0.39063787,
                           0.31554574, 0.30872473, 0.05052919, 0.0491369, 0.3033615, 0.40541017,
                           0.56313765, 0.16352025, -0.20833959, -0.37054086, 0.3014414, 0.29997066,
                           0.4112059, 0.4070201, -0.10218871, -0.32133728, 0.37037715, 0.33451155])
