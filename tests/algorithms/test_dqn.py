...
def test_prioritized_dqn():
    ...
    w = approximator.get_weights()
    w_test = torch.tensor([-0.19971870, 0.23901856, -0.02347297, 0.32159477, -0.35603973,
                           -0.00871724, -0.06996530, 0.43689770, 0.16555829])
...
def test_categorical_dqn_prioritized():
    ...
    w_test = torch.tensor([0.99492681, 0.30372638, -0.38039818, -0.66229630, -0.70050967, 0.45887721,
                           -0.12906331, -0.45170408, -0.46869084, -0.01793555, 0.13370971, 0.09729694,
                           0.66298205, 0.59981567, -1.13012791, 0.82512254, 0.02841160, 0.07125450])
...
def test_quantile_dqn_prioritized():
    ...
    w = agent.approximator.get_weights()
    w_test = torch.tensor([-0.32953724, 0.54472113, 0.24169940, -0.07950477, -0.61509699,
                           0.35881358, -1.12328517, 0.69162154, 0.36370972, 1.23972535,
                           -0.11985977, 0.01031533, 0.73459572, -1.04432285, -1.09142709,
                           -0.51700962, -0.19440261, -0.34549186, 0.99952668, -0.13364422,
...
def test_rainbow():
    ...
    w_test = torch.tensor([0.42845434, -0.24809416, -0.20118916, 0.26788655, 0.41274157, 0.40684506,
                           ...
                           -0.11818635, 0.38609692, 0.07101645, -0.11294184, 0.37428197, 0.37702212,
                           0.32961598, 0.32767880, 0.18715654, 0.04385008, 0.34483591, 0.36077034,
                           0.30864027, -0.22007944, -0.10193933, -0.11913970, 0.39863941, 0.40309867,
                           0.30896536, 0.30512568, 0.09705524, 0.00261080, 0.34753001, 0.36029631,
                           0.55655891, 0.15793894, -0.20176075, -0.36495951, 0.29862180, 0.29928797,
...
def test_rainbow_ensemble():
    ...
    w = approximator.get_weights()
    w_test = torch.tensor([[0.43343484, -0.24157998, -0.20616950, 0.26137239, 0.41191459,
                            0.41725555, 0.29342476, 0.28889030, -0.58864588, 0.34701362,
                            0.42389163, 0.28162596, -0.12972784, 0.37265050, 0.08255789,
                            -0.09949530, 0.36673626, 0.36744103, 0.33211154, 0.33214206,
                            0.19507909, 0.03592752, 0.35160932, 0.35001242, 0.32032481,
                            ...
                            0.29050288, 0.28959396, 0.41448954, 0.41392371, -0.12040638,
                            -0.30311960, 0.35375032, 0.35277453],
                           [-0.16890033, 0.09132322, 0.36383510, 0.32687274, 0.40145576,
                            ...
                            -0.05159308, 0.24131249, -0.39478952, 0.40739870, 0.41463229,
                            0.29969510, 0.29482201, 0.63608932, -0.24143942, 0.29797107,
