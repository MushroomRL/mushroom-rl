...
from mushroom_rl.environments.mujoco_envs import MJEnv
...
def experiment(n_epochs, n_steps, n_episodes_test):
    ...
    logger.strong_line()
    logger.info('Hand Manipulation Suite (Door Opening) Experiment, Algorithm: SAC')
...
if __name__ == '__main__':
    experiment(n_epochs=250, n_steps=10000, n_episodes_test=10)
