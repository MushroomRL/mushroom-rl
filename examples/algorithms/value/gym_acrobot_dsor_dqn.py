"""
Simple script to solve the Acrobot problem with DSOR-DQN.
...
def experiment(n_epochs, n_steps, n_steps_test, render=True, use_cuda=False, seed=None):
    ...
    logger = Logger(DSORDQN.name(), results_dir=None)
    logger.log_experiment_info(DSORDQN, mdp, n_epochs=n_epochs, n_steps=n_steps, n_steps_test=n_steps_test)
